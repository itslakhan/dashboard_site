        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="list-group">
                    <a href="{{ route('trainer_list') }}" class="list-group-item list-group-item-action">View Trainers</a>
                    <a href="{{ route('member_list') }}" class="list-group-item list-group-item-action">View Members</a>
                </div>
            </div>
